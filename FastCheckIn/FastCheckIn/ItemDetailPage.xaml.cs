using FastCheckIn.Common;
using FastCheckIn.Data;
using System;
...
namespace FastCheckIn
{
    ...
    public sealed partial class ItemDetailPage : Page
    {
        ...
        {
            await MyService.InsertGuestAsync(new ServiceReference1.GuestData { //IGuest_ID = IdTextbox.Text, 
                IName = NameTextbox.Text, IFirstName = AddTextBox.Text });
        } 
...

        {
            ...
            foreach (var Guest in GuestList)
            {
              ...
              //  Spanel.Children.Add(new TextBlock() { Text = Guest.IGuest_ID });
                Spanel.Children.Add(new TextBox() { Text = Guest.IName });
                Spanel.Children.Add(new TextBlock() { Text = Guest.IFirstName });
